...
sed -i 's/^USE_OTP=.*/USE_OTP=EMAIL # EMAIL (code by mail), GA (authenticator app), TEST (111111)/' "$VT_HOME/express-template/apps/sample-api/.env"
...
log "Done"
echo "  Vue+Express   http://$PUBLIC_IP/          login test / test, OTP 111111"
